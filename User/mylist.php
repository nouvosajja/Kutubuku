...
$queryNext = "SELECT * FROM todolist WHERE user_id = $user_id AND DATE(due_date) > '$today' ORDER BY due_date ASC";
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10 content">
                            ...
                            <?php foreach ($todosToday as $todo): ?>
                                <div class="todo-item">
                                    <div class="row align-items-center px-4 todo-text">
                                        ...
                                        <div class="col text-center text-capitalize"><?= htmlspecialchars($todo['kategori']); ?></div>
                ...
                <!-- Whats next -->
                <div class="col-12 rounded-box">
                    <h5 class="fw-bold">What's Next</h5>
